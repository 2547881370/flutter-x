...
//
//     final postsPraiseModel = postsPraiseModelFromJson(jsonString);

import 'dart:convert';

PostsPraiseModel postsPraiseModelFromJson(String str) =>
    PostsPraiseModel.fromJson(json.decode(str));

String postsPraiseModelToJson(PostsPraiseModel data) =>
    json.encode(data.toJson());

class PostsPraiseModel {
  PostsPraiseModel({
    this.data,
    this.code,
    this.message,
  ...
  factory PostsPraiseModel.fromJson(Map<String, dynamic> json) =>
      PostsPraiseModel(
